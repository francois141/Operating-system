...
ld -m elf_i386 -s -o kernel.bin -Ttext 0x100000  kernel_entry.o low_level.o \
  system.o screen.o interrupt.o  gdt.o gdt_asm.o idt.o ist.o pci.o ata.o math.o snake.o pc_speaker.o malloc.o vfs.o paging.o timer.o keyboard.o libgui.o shell.o string.o kernel.o --oformat binary -e 0x100000
